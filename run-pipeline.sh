...
ln -s ../../../data/pics/ wackywango/gui/static/pics
...
sleep 5
docker run --rm --detach --network=wackywangonet -p 8080:8080 -v $PWD/data/:/tmp/wackywangodata wackywangoimage  /bin/bash -c "python -m wackywango.gui run-server -h '0.0.0.0' -p 8080 -H 'api-server' -P 5000"
