...
_sym_db.RegisterEnumDescriptor(_PARSERTYPE)

ParserType = enum_type_wrapper.EnumTypeWrapper(_PARSERTYPE)
TypePose = 0
TypeColorImage = 1
TypeDepthImage = 2
TypeFeelings = 3
...
_UPLOADSNAPSHOT = _descriptor.Descriptor(
  name='UploadSnapshot',
  full_name='UploadSnapshot',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='user', full_name='UploadSnapshot.user', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='UploadSnapshot.snapshot', index=1,
...
_UPLOADPARSERRESULT = _descriptor.Descriptor(
  name='UploadParserResult',
  full_name='UploadParserResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='user', full_name='UploadParserResult.user', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parser_type', full_name='UploadParserResult.parser_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='UploadParserResult.data', index=2,
...
_UPLOADSNAPSHOT.fields_by_name['user'].message_type = _USER
_UPLOADSNAPSHOT.fields_by_name['snapshot'].message_type = _SNAPSHOT
_UPLOADPARSERRESULT.fields_by_name['user'].message_type = _USER
_UPLOADPARSERRESULT.fields_by_name['parser_type'].enum_type = _PARSERTYPE
...
DESCRIPTOR.message_types_by_name['UploadSnapshot'] = _UPLOADSNAPSHOT
DESCRIPTOR.message_types_by_name['UploadParserResult'] = _UPLOADPARSERRESULT
...
DESCRIPTOR.enum_types_by_name['ParserType'] = _PARSERTYPE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

UploadSnapshot = _reflection.GeneratedProtocolMessageType('UploadSnapshot', (_message.Message,), {
  'DESCRIPTOR' : _UPLOADSNAPSHOT,
  '__module__' : 'cortex_pb2'
  # @@protoc_insertion_point(class_scope:UploadSnapshot)
  })
_sym_db.RegisterMessage(UploadSnapshot)

UploadParserResult = _reflection.GeneratedProtocolMessageType('UploadParserResult', (_message.Message,), {
  'DESCRIPTOR' : _UPLOADPARSERRESULT,
  '__module__' : 'cortex_pb2'
  # @@protoc_insertion_point(class_scope:UploadParserResult)
  })
_sym_db.RegisterMessage(UploadParserResult)
